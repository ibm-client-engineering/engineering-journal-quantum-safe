...
- Fidelity adheres to role based access for all their environments. 
...
|m6i.2xlarge|3|24 (8 cores x Count)|96G (32G x Count)| 250Gb EBS, 200Gb EBS (additional)|
|**Totals**|7|52|152G| 1653Gb |
...
Fidelity primarily uses EBS and EFS. 
...
- IBM Quantum Safe Remediator Adaptive Proxy ([QSR](https://www.ibm.com/docs/en/quantum-safe/quantum-safe-explorer/1.0.x))
- IBM Quantum Safe Explorer ([QSE](https://www.ibm.com/docs/en/quantum-safe/quantum-safe-remediator/1.0.x)) 
- QSPM 
...
- QSR
  ...
  - Presumably can be deployed to OCP or any kubernetes as it is a container
...
- QSPM
  - Current specs require OCP cluster
