...
You can find the required installation files for your OS of choice on IBM's Passport Advantage. The scope of this installation will cover MacOS.
...
Extracted they create the following directories
...
:::note
This guide assumes the user's desktop is MacOS
:::
...
Make sure you have the `code` cli for MacOS enabled. This is how you do [that](https://code.visualstudio.com/docs/setup/mac)
:::
