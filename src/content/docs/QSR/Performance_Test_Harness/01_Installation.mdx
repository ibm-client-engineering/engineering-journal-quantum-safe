...
Enter the target FQDN list seperated by space (TARGET_FQDN_LIST): 9.46.99.87 10.21.34.204
Enter the target IP list seperated by space (TARGET_IP_LIST): 9.46.99.87 10.21.34.204
Enter the test FQDN (TESTFQDN): apache-host01.fyre.ibm.com
```
...
Performance test server continer started RC=0, container id 318e77d157114d84915654f86cc8c3a225c689e9983bb9d38fbc6b5cbdefc22d.
