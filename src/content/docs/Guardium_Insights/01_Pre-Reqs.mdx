...
Retrieve the `ibm-guardium-insights` case file. As of this writing the latest is 2.4.0.

<Tabs syncKey="OS">
<TabItem label="MacOs">
```tsx
wget https://github.com/IBM/cloud-pak/raw/master/repo/case/ibm-guardium-insights/2.4.0/ibm-guardium-insights-2.4.0.tgz
```
Extract the downloaded casefile in your directory

```tsx
tar zxf ibm-guardium-insights-2.4.0.tgz
```
