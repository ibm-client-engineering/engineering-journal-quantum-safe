...
This assumes you've mirrored all required GI and CPFS images to your private registry.

Set the following vars:

```tsx
export ARGS="--registry your.private.reg --recursive --inputDir ${LOCAL_CASE_DIR}"
```
...
```tsx
export ARGS="--size ${ICS_SIZE} --ks_flag true --hostname ${HOSTNAME} --registry your.private.reg --user yourprivreguser --pass yourprivateregpass --secret yoursecretkey --recursive --inputDir ${LOCAL_CASE_DIR}"
```
...
![Webui](../../../assets/images/webui01.png)import { TabItem, Tabs } from '@astrojs/starlight/components';
