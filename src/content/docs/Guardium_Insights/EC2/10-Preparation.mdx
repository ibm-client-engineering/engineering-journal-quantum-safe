...
Search ***clusters.yaml*** for ```REPLACE_ME_WITH_SUBNET_ID``` and replace with a public subnetID.
...
[Download the OCPInstall_Role.yaml](https://ibm-client-engineering.github.io/engineering-journal-quantum-safe/Cloudformation/OCPInstallRole.yaml)
...
### Deply cloudformation templates using AWS CLI
...
--parameter-overrides file://parameters-override.json \
